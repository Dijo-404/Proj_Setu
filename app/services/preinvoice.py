...
def sale_preinvoice_pdf(batch: Batch, settings: dict[str, str]) -> bytes:
    ...
    document = SimpleDocTemplate(
        ...
        author=settings.get("company_name") or "Setu",
        pageCompression=0,
    )
        ...
        [
            [
                [
                    ...
                    Paragraph("Sales pre-invoice generated by Setu", small),
                ],
                document_details,
            ]
        ],
    ...
    notice = Table(
        [
            [
                Paragraph(
                    "This document is a provisional pre-invoice generated from the Setu sale reference. "
